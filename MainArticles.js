var posts = [
    ...
    {id : 5, titel : "سلام", category : "تغذیه", image: "../assets/images/running.PNG", text : "یوگا یکی از ورزش‌هایی است که می‌تواند شما را قوی و انعطاف پذیر کند و احساس تمرکز و هوشیاری بیشتری ببخشد. این ورزش آرامش‌بخش کمک می‌کند احساس عال"},
...
$(document).ready(function(){
    ...
    $.get("article_Template.html", function(data) {
        ...
        var limitedPosts = posts.slice(0, 4);
